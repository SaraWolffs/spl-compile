        ...
        Some(Ok(match chr {
            ...
            x => {
                if x.is_alphabetic() {
                    ...
                    fail!("Unrecognized character", self.loc)
                }
            }
        }))
    }
